# Обновление Publikator 0.6.x / 0.7.0 → 0.8.0-rc.1 → V1

Publikator 0.8.0-rc.1 сохраняет архитектуру одного production-контейнера и локального `data/`, но поднимает SQLite schema с **1 до 2** для хранения live release acceptance.
