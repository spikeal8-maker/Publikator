...
export const SCHEMA_MILESTONES = [
  ...
  { version: 13, key: 'editorial-metadata', migrationRegression: 'scripts/schema-v13-editorial-metadata-e2e.mjs', backupRegression: 'scripts/backup-v13-editorial-metadata-e2e.mjs' }
