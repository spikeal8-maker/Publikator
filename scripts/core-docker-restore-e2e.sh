...
jq -e '.format == "publikator-backup" and .formatVersion == 1 and .schemaVersion == 9 and .counts.media == 2 and (.mediaFiles | length) == 2' \
...
echo '{"ok":true,"productionDocker":true,"fullBackupRestore":true,"schemaVersion":9}'
