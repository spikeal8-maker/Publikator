...
try {
  ...
  console.log(JSON.stringify({ ok: true, from: 3, to: 7, readyRevisionBackfill: true, provenanceColumns: true, historicalSnapshotBackfill: true, queuedNormalized: true, rerunSafe: true }, null, 2));
} finally {
  db.close();
